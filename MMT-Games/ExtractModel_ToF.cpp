    ...
    for (const auto& pair : this->DrawIB_ExtractConfig_Map) {
        ...
        if (extractConfig.GameType == L"Auto") {
            ...
            for (const auto& pair : d3d11GameTypeLv2.GameTypeName_D3d11GameType_Map) {
                ...
                uint64_t NormalStride = MMTFile::GetFileSize(G.WorkFolder + NormalExtractFileName) / MatchNumber;
                uint64_t TexcoordStride = MMTFile::GetFileSize(G.WorkFolder + TexcoordExtractFileName) / MatchNumber;
            ...
            D3D11GameType matchGameTypeObject = d3d11GameTypeLv2.GameTypeName_D3d11GameType_Map[MMTString::ToByteString(MatchedGameType)];
