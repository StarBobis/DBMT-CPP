...
void Functions_HSR::GenerateMod() {
    ...
    SingleIniBuilder HSRIniBuilder;
    ...
    for (const auto& pair : this->DrawIB_ExtractConfig_Map) {
        ...
        if (drawIBConfig.KeyNumber != 0) {
            ...
            HSRIniBuilder.AppendSection(ConstantsSection);
            ...
            HSRIniBuilder.AppendSection(PresentSection);
            ...
            for (const auto& TogglePair : drawIBConfig.ModelPrefixName_ToggleNameList_Map) {
                ...
                if (ToggleNameList.size() >= 2) {
                    ...
                    KeySection.NewLine();
                    HSRIniBuilder.AppendSection(KeySection);
    ...
    HSRIniBuilder.SaveToFile(G.ModOutputFolder + L"Config.ini");
