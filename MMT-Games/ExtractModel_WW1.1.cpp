...
void Functions_WW11::ExtractModel_FromBuffer_WW11(std::wstring DrawIB, std::wstring GameType) {
    ...
    AutoDetectTextureFiles_WW11(DrawIB, MatchFirstIndex_PartName_Map, d3d11GameType.GPUPreSkinning, this->PartName_TextureSlotReplace_Map, this->TextureTypeList);
